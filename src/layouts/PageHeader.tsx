...
import { Menu, Mic, Upload, Bell, User, Search, ArrowLeft } from "lucide-react"
    ...
    <div className="flex gap-10 lg:gap-20 justify-between pt-2 mb-6 mx-4">
        ...
        <div className="flex flex-grow max-w-[600px]">
            <input type ="search" placeholder="Search" className="rounded-l-full border 
                border-secondary-border shadow-inner shadow-secondary py-1 px-4 text-lg w-full focus:border-blue-500 outline-none"/>
